...
public class WhizzyWands implements ModInitializer {
    ...
    public static final ItemGroup ITEM_GROUP = FabricItemGroupBuilder.create(new Identifier("whizzy_wands", "wands"))
            ...
            .build();
    public static final Identifier PACKET_ID = new Identifier(NAMESPACE, "spawn_packet");
    ...
    public void onInitialize() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(NAMESPACE, "whizzy_wood_stairs"), Content.WHIZZY_WOOD_STAIRS);
        Registry.register(Registry.BLOCK, new Identifier(NAMESPACE, "whizzy_wood_slab"), Content.WHIZZY_WOOD_SLAB);
        ...
        Registry.register(Registry.ITEM, new Identifier(NAMESPACE, "whizzy_wood_stairs"), new BlockItem(Content.WHIZZY_WOOD_STAIRS, new FabricItemSettings().group(ITEM_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(NAMESPACE, "whizzy_wood_slab"), new BlockItem(Content.WHIZZY_WOOD_SLAB, new FabricItemSettings().group(ITEM_GROUP)));

        // Items
        Registry.register(Registry.ITEM, new Identifier(NAMESPACE, "wand_core"), Content.WAND_CORE);
        Registry.register(Registry.ITEM, new Identifier(NAMESPACE, "grapple_wand_hook"), Content.GRAPPLE_WAND_HOOK);
        ...
        // Entities
        Registry.register(Registry.ENTITY_TYPE, new Identifier(NAMESPACE, "grapple_wand_hook"), Content.ENTITY_GRAPPLE_WAND_HOOK);

        // Features
        // TODO: Re-add whizziwood trees to worldgen
